    ...
    <section id="techstack">
      <div className="tech-container">
        <div class="tech-heading-container">
          <h1 class="tech-heading-outline">SKILLS</h1>
          <h2 class="tech-heading-overlay">MY SKILLS</h2>
        </div>
        <div className="tech-box-group">
          ...
          <div className="tech-box">
            <img
              src="https://devicon-website.vercel.app/api/mysql/plain.svg?color=%23021821"
              width="150"
              height="150"
              alt="C"
              style={{ maxWidth: "100%" }}
            ...
            />
            <img
              src="https://devicon-website.vercel.app/api/redis/original.svg"
              width="150"
              height="150"
              alt="C"
              style={{ maxWidth: "100%" }}
          ...
          <div className="tech-box">
            ...
            />
            <img
              src="https://devicon-website.vercel.app/api/jenkins/original.svg"
              width="150"
              height="150"
              alt="C"
              style={{ maxWidth: "100%" }}
