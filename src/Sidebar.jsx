...
function Sidebar() {
  useEffect(() => {
    const sections = document.querySelectorAll("section"); // Adjust for sections
  ...
  return (
    <div className="sidebar">
      <a href="https://www.linkedin.com/in/mohamednuman/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
        <svg
      ...
      <a href="https://github.com/num4n1" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          role="img"
          className="sidebar-icon"
